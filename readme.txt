...
Displays iTunes info using a shortcode.  
...
**[Plugin Website. Support in comments.](http://wpgiraffe.com/2011/08/29/plugin-get-itunes-info/)**
...
4. You can include two attributes, id is required, full is optional 
	id 	= the iTunes id of the item whose info you want
	full	= yes or no. yes will return "Current Price: $" before the price, no won't. Defaults to yes.
